...
function inicioSesion() {
    ...
    buttonLogin.setAttribute("class", "btn btn-outline-primary float-right mt-5");
...
function singIn() {
    ...
    if (user === "prueba" && pass === "prueba") {
        ...
        window.location.href = 'http://localhost/Formularios'; //Cuando iniciemos sesión la página nos manda a esa localización web
    } else {
...
function singOut() { //Arreglar esta función al final
    ...
    window.location.href = 'http://localhost/Formularios'; //Cuando cerremos sesión la página nos manda a esa localización web
}
...
function formCreateProduction() {
    function newProduction() {
            ...
            for (var t = 0; t < long; t++){
                if (tipo[t].checked) {
                    if (tipo[t].value === "movie") {
                        ...
                        var dires = document.getElementsByClassName("producDirector");
                        var long = dires.length;
                        ...
                        for (var d = 0; d < long; d++) {
                            ...
                            if (dires[d].checked) {
                                ...
                                while (found !== true) {
                                    var directNameApe = director.value.name + " " + director.value.lastname1;
                                    if (directNameApe === dires[d].value) {
                                        VSystem.assignDirector(director.value, nuevaMovie);
                                        found = true;
                                    }
                                    director = directors.next();
                                }
                        ...
                        var acts = document.getElementsByClassName("producActor");
                        var long = acts.length;
                        ...
                        for (var a = 0; a < long; a++) {
                            ...
                            if (acts[a].checked) {
                                ...
                                while (found !== true) {
                                    var actNameApe = actor.value.name + " " + actor.value.lastname1;
                                    if (actNameApe === acts[a].value) {
                                        VSystem.assignActor(actor.value, nuevaMovie);
                                        found = true;
                                    }
                                    actor = actors.next();
                                }
                        ...
                        for (var d = 0; d < long; d++) {
                            ...
                            if (dires[d].checked) {
                                ...
                                while (found !== true) {
                                    var directNameApe = director.value.name + " " + director.value.lastname1;
                                    if (directNameApe === dires[d].value) {
                                        VSystem.assignDirector(director.value, nuevaSerie);
                                        found = true;
                                    }
                                    director = directors.next();
                                }
                        ...
                        for (var a = 0; a < long; a++) {
                            ...
                            if (acts[a].checked) {
                                ...
                                while (found !== true) {
                                    var actNameApe = actor.value.name + " " + actor.value.lastname1;
                                    if (actNameApe === acts[a].value) {
                                        VSystem.assignActor(actor.value, nuevaSerie);
                                        found = true;
                                    }
                                    actor = actors.next();
                                }
        ...
        while (director.done !== true) {
            ...
            inputChecks.setAttribute("class", "form-check-input producDirector");
            inputChecks.setAttribute("id", "producDirector");
            inputChecks.setAttribute("value", productionDirector);
            divChecks.appendChild(inputChecks);
        ...
        while (actor.done !== true) {
            ...
            inputChecks.setAttribute("class", "form-check-input producActor");
            inputChecks.setAttribute("id", "producActor");
            inputChecks.setAttribute("value", productionAct);
            divChecks.appendChild(inputChecks);
